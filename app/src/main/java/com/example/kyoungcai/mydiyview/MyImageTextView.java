...
import com.example.kyoungcai.mydiyview.myview.Utils;
...
public class MyImageTextView extends LinearLayout {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if(widthSpaceMode==MeasureSpec.AT_MOST&&heightSpaceMode==MeasureSpec.AT_MOST){
            ...
            measuredHeight=getChildAt(0).getMeasuredHeight()+getChildAt(1).getMeasuredHeight();
        ...
        if(widthSpaceMode==MeasureSpec.AT_MOST&&heightSpaceMode==MeasureSpec.AT_MOST&&isH){
            ...
            measuredWidth=getChildAt(0).getMeasuredWidth()+getChildAt(1).getMeasuredWidth();
            setMeasuredDimension(measuredWidth,measuredHeight);
        }
